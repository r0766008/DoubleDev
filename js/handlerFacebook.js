...
$(window).on("resize load", function () {
    ...
    if (clientWidth != newWidth) {
            ...
            try {
                ...
                if (fb_page.getAttribute("fb-xfbml-state") == "rendered" && fb_page.getAttribute("data-height") == desired_height && rerendered) {
                    ...
                    setTimeout(function () {
                        ...
                        fb_container.className = "col s12  l6 center z-depth-2";
        ...
        time = setTimeout(function () {
            ...
            fb_plugin.innerHTML = '<div class="fb-page z-depth-2" data-href="https://www.facebook.com/Double-Dev-297059091163262" data-width="' + fb_plugin.offsetWidth + '" data-height="' + element_with_desired_height.offsetHeight + '" data-tabs="timeline" data-small-header="false" data-hide-cover="false" data-show-facepile="true"> <blockquote cite="https://www.facebook.com/Double-Dev-297059091163262/?view_public_for=297059091163262" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Double-Dev-297059091163262">Double Dev</a></blockquote></div>';
            // Render the plugin
            FB.XFBML.parse();
