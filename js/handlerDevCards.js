...
$(document).ready(function () {
    ...
    function opened_developer_card(e) {
        ...
        clicked_card.querySelector(".dev_close a").tabIndex = "0";

        if (last_opened_card_id != undefined && last_opened_card_id != clicked_card.id)
            document.getElementById(last_opened_card_id).getElementsByClassName("dev_close")[0].click();
        ...
        clicked_card.querySelector(".dev_close a").focus();
    ...
    // When clicking on dev_close icon, close developer card
    ...
    $(".dev_close").on("click keydown", close_developer_card);
